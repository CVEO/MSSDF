...
class TxtfileLogger(object):
    def __init__(self, log_dir):
        self.log_dir = log_dir

        self.logger = logging.Logger("TxtfileLogger", logging.INFO)
...
def cosine_scheduler(
    ...
    t = np.cos((iters / len(iters)) * math.pi) + 1
    schedule = final_value + 0.5 * (base_value - final_value) * t
    # schedule = np.array(
    #     [
    #         final_value
    #         + 0.5
